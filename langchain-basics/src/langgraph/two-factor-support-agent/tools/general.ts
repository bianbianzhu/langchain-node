...
export const orderLookupTool = tool(
  ...
  },
  {
    ...
    schema: z.object({
      purchaser_name: z
        .string()
        .describe("The name of the person requesting the information"),
...
export const refundTool = tool(
  ...
  },
  {
    ...
    description:
      "Refunds a LangCorp purchase. Should only be called after collecting sufficient information.",
    schema: z.object({
      langcorp_order_id: z
        .string()
        .describe("The LangCorp order id of the purchase"),
      purchaser_name: z
        .string()
        .describe("The name of the person who would like the refund"),
    }),
  }
);
